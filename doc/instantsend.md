...
This mechanism has been integrated into Bitcore-Node-Sphere which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/spherepay/insight-api-sphere#web-socket-api](https://github.com/spherepay/insight-api-sphere#web-socket-api) 
* API: [https://github.com/spherepay/insight-api-sphere#instantsend-transactions](https://github.com/spherepay/insight-api-sphere#instantsend-transactions) 
...
By default, the Sphere Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sphere Core daemon:
