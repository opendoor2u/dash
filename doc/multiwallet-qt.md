...
Only requiring some minor changes is sphere.cpp.
...
Changes to sphere.cpp
----------------------
sphere.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
