 ...
 *
 *   // network
 *   CSphereNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sphere.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSphereNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SphereNetwork
// //   -- signature requirements : Key1(User)
// class CSphereNetworkVariable : public CGovernanceObject
// {
// private:
