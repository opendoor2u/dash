...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SphereNetwork") type = SphereNetwork;
    if(strType == "SphereNetworkVariable") type = SphereNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SphereNetwork) s = "SphereNetwork";
    if(type == SphereNetworkVariable) s = "SphereNetworkVariable";
