...
{
    if(fLiteMode) return; // ignore all Sphere related functionality
...
/*
    ...
    allow endless transaction that would bloat Sphere and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("sphere-privatesend");
