    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sphere Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sphere address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sphere: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sphere Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sphere Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sphere Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sphere addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sphere addresses"));
    ...
    openAction->setStatusTip(tr("Open a sphere: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sphere Core help message to get a list with possible Sphere Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sphere Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sphere network", "", count));
}
...
{
    QString strTitle = tr("Sphere Core"); // default title
