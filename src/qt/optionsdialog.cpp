    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SPHERE-light"), QVariant("light"));
    ui->theme->addItem(QString("SPHERE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SPHERE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SPHERE-traditional"), QVariant("trad"));
