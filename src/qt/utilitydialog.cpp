    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sphere Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sphere Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sphere-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sphere in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPHERE, 0.1 SPHERE, 1 SPHERE and 10 SPHERE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://spherepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://spherepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sphere Core is shutting down...") + "<br /><br />" +
